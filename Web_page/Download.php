            ...
            <div class="max-w-5xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800 text-center">
                        ...
                        <a href="https://omniboard.gateway.scarf.sh/latest/OmniBoard_Online_Installer.exe" download class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-colors">Download for Windows</a>
                    </div>
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800 text-center">
                        ...
                        <a href="https://omniboard.gateway.scarf.sh/latest/install.sh" download class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-colors">Download for Linux</a>
                    </div>
                </div>
