...
<body class="bg-slate-900 text-slate-100 font-sans antialiased min-h-screen flex flex-col">
    ...
    <header class="max-w-4xl mx-auto px-6 py-16 text-center">
        <h1 class="text-4xl font-extrabold tracking-tight text-white mb-6">How to Create a Button controlled LED Project</h1>
        <p class="text-lg text-slate-400 max-w-2xl mx-auto">In this tutorial, we will guide you through creating a simple button controlled LED project using OmniBoard Studio.</p>
    </header>
    ...
    <main class="max-w-4xl mx-auto px-6 py-12 space-y-16 flex-grow">
        <section>
            ...
            <div class="space-y-4">
                ...
                <div class="p-5 bg-slate-800 border border-slate-700 rounded-xl">
                    ...
                    <p class="text-slate-300 mt-1">Drag and drop the necessary blocks to create a simple circuit that controls an LED with a button.</p>
                    <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 mt-4">
                        ...
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Then connect the While True block to a Button block. This will allow us to check the state of the button.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Finally connect the True output of the Button block to a LED ON block. This will cause the LED to turn on. To the False output connect a LED OFF block. This will cause the LED to turn off.</span>
                        </li>
                    </ul>
                    <figure class="mt-6">
                        <img src="Button_led/Button_led_Flowchart.png" alt="Button controlled LED Blocks" class="rounded-lg border border-slate-700">
                        <figcaption class="text-sm text-slate-500 mt-2">Example block arrangement for a button controlled LED project.</figcaption>
                    </figure>
                </div>
                <div class="p-5 bg-slate-800 border border-slate-700 rounded-xl">
                    ...
                    <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 mt-4">
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Connect the button to the correct GPIO pin on your microcontroller. This will allow the Button block to read the state of the button correctly. Your usual button will have two pairs of pins. You will need to connect one pair to a GPIO pin and the other pair to 3.3V.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Now you can try to connect the LED from memory because the circuit is the same as in the previous tutorial. Or click to reveal the circuit diagram and instructions.</span>
                        </li>
                        <details class="bg-slate-800 border border-slate-700 rounded-xl p-4 group transition-all duration-300">
                            ...
                            <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 mt-4">
                                ...
                                <figure class="mt-4">
                                    ...
                                    <figcaption class="text-sm text-slate-500 mt-2">Example circuit diagram for a button controlled LED project.</figcaption>
                                </figure>
                            </ul>
                        </details>
                    </ul>
        ...
        <section>
            ...
            <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50">
                ...
                <li class="flex items-start gap-3">
                    <span>Here is an example of simplified the MicroPython code that would be generated by the blocks for a button controlled LED project:</span>
                </li>
