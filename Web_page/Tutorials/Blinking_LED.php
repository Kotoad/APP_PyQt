    ...
    <main class="max-w-4xl mx-auto px-6 py-12 space-y-16 flex-grow">
        <section>
            ...
            <div class="space-y-4">
                ...
                <div class="p-5 bg-slate-800 border border-slate-700 rounded-xl">
                    ...
                    <p class="text-slate-300 mt-1">Drag and drop the necessary blocks to create a simple circuit that turns an LED on and off.</p>
                    <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 mt-4">
                        ...
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Then connect the While True block to a Toggle LED block. This will cause the LED to toggle between on and off states.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Finally connect the Timer block to the Toggle LED block. This will create the desired blinking effect. You can adjust the timer duration to change the blinking speed as you wish.</span>
                        </li>
                    </ul>
                    <figure class="mt-6">
                        <img src="Blinking_LED/Blinking_LED_Flowchart.png" alt="Blinking LED Blocks" class="rounded-lg border border-slate-700">
                        <figcaption class="text-sm text-slate-500 mt-2">Example block arrangement for a blinking LED project.</figcaption>
                    </figure>
                </div>
                <div class="p-5 bg-slate-800 border border-slate-700 rounded-xl">
                    ...
                    <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 mt-4">
                        ...
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">●</span>
                            <span>Connect the positive leg of the LED to a resistor, and then connect the other end of the LED to ground. You can determine which leg is positive and which is negative by finding the longer leg (positive) and shorter leg (negative) or flat side of the LED cover (negative).</span>
                        </li>
                    </ul>
                    <figure class="mt-6">
                        <img src="Blinking_LED/Blinking_LED_Circuit.png" alt="Blinking LED Circuit" class="rounded-lg border border-slate-700">
                        <figcaption class="text-sm text-slate-500 mt-2">Example circuit for a blinking LED project.</figcaption>
                    </figure>
                </div>
                <div class="p-5 bg-slate-800 border border-slate-700 rounded-xl">
                ...
                <div class="p-5 bg-slate-800 border border-slate-700 rounded-xl">
                    ...
                    <p class="text-slate-300 mt-1">Watch your LED blink on and off at the interval you set with the Timer block!</p>
                </div>
            </div>
        </section>
        ...
        <section>
            ...
            <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50">
                ...
                <li class="flex items-start gap-3">
                    <span>Here is an example of simplified the MicroPython code that would be generated by the blocks for a blinking LED project:</span>
                </li>
...
while True: # Create an infinite loop to keep the LED blinking
    ...
    time.sleep(0.5) # Wait for 0.5 seconds before repeating the loop
                </code></pre>
                <li class="flex items-start gap-3">
...
while True: # Create an infinite loop to keep the LED blinking
    ...
    time.sleep(0.5) # Wait for 0.5 seconds before repeating the loop
                ...
                <li class="flex items-start gap-3"> 
                    <span>LED stands for Light Emitting Diode. It is a semiconductor device that emits light when an electric current passes through it. LEDs are widely used in electronic circuits for indication and display purposes due to their efficiency, long lifespan, and low power consumption.</span>
                </li>
                <li class="flex items-start gap-3">
                ...
                <li class="flex items-start gap-3">
                    <span>
                         An LED can be thought of as a "light bulb" in a circuit. When electricity flows through it, it produces light, making it useful for visual indicators and displays in electronic projects.
                    </span>
                </li>
                <li class="flex items-start gap-3">
                ...
                <li class="flex items-start gap-3">
                    <span>A resistor is an electronic component that limits the flow of electric current in a circuit. It is used to protect components like LEDs from receiving too much current, which can damage them. Resistors are essential for controlling the amount of current that flows through different parts of a circuit.</span>
                </li>
                <li class="flex items-start gap-3">
                    <span class="text-blue-500 mt-1">In simple terms, what is a resistor?</span>
                </li>
                <li class="flex items-start gap-3">
                    <span>A resistor can be thought of as a "gatekeeper" in a circuit that controls how much electricity flows through it. It helps ensure that components like LEDs receive the right amount of current to function properly without getting damaged.</span>
                </li>
            </ul>
        </section>
    </main>
