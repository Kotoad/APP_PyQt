...
<body class="bg-slate-900 text-slate-100 font-sans antialiased min-h-screen flex flex-col">
    ...
    <header class="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <p class="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
            Build and compile MicroPython and Python projects seamlessly. A complete visual node environment with built-in code editing for Raspberry Pi Pico and more.
        </p>
            ...
            <div class="max-w-5xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        ...
                        <p class="text-slate-400">Instantly translate visual node graphs into optimized MicroPython and Python code ready for deployment to connected devices.</p>
                    </div>
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
